# Candidate Policy Proposal: stress_es_anthropic_ipo_rumor_vs_no_ipo_008

## Problem

Gemini advisory classification returned `indirect`
for a case constructed as `no_clean_expression`.
