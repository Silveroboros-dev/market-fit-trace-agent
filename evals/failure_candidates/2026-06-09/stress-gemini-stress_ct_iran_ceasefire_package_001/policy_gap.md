...
- Case: `stress_ct_iran_ceasefire_package_001`
- Family: `composite_thesis`
- Expected fit: `weak_proxy`
- Gemini advisory fit: `indirect`
- Deterministic fit: `weak_proxy`
- Phoenix trace: https://app.phoenix.arize.com/s/rukar570/traces/f6c8b6e6a19daf0fa29164905e002da9
