# Candidate Policy Proposal: stress_if_dollar_weakening_vs_rate_cut_005

## Problem

Gemini advisory classification returned `no_clean_expression`
for a case constructed as `weak_proxy`.
